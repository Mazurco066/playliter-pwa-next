...
const { define } = aceInstance

define('ace/mode/chordpro', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/chordpro_highlight_rules'], function (require: any, exports: any, module: any) {
  ...
  (function (this: any) {
    this.createWorker = function (session: any) {
      return null
    }
...
define('ace/mode/chordpro_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (require: any, exports: any, module: any) {
  const oop = require('../lib/oop')
